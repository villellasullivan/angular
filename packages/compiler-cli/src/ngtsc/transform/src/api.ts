...
export enum HandlerFlags {
   ...
   * to normally inherited aspects such as inputs and queries, full inheritance applies to every
   * aspect of the component or directive, such as the template function itself.
   *
